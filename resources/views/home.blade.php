        ...
        <section class="new_arrivals_area section_padding_100_0 clearfix">
            ...
            <div class="karl-projects-menu mb-100">
                <div class="text-center portfolio-menu">
                    @foreach($categories as $category)
                        @if($loop->index == 0)
                            <button class="btn active" data-filter="*" value="1">{{ \Illuminate\Support\Str::upper($category->category_name) }}</button>
                        @else
                            <button class="btn" data-filter="{{ '.' . $category->category_name}}" value="{{ $category->id }}">{{ \Illuminate\Support\Str::upper($category->category_name) }}</button>
                        @endif
                    @endforeach
                </div>
            </div>
            ...
            <div class="container">
                <div class="row karl-new-arrivals">
                    <x-card-section :products="$products">
                    </x-card-section>
                    </div>
                </div>
            <!--</div>-->
