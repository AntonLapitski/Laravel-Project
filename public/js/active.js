    ...
    $('.slider-range-price').each(function () {
        ...
        $(this).slider({
            ...
            change: function( event, ui ) {
                ...
                // console.log(document.querySelector('.range-price').innerHTML);
            },
            stop: function(event, ui) {
                //console.log(`stop ${ui.values[1]}`);
                //$('.range-price').addClass("my-test");
               /* $.ajax({
                    url: "/get-paginated-by-price",

                    type:'GET',

                    data: {_token: '', data: ui.values},
